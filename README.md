...
The StarDist plugin can be installed in [Fiji](https://fiji.sc) via the update site `https://sites.imagej.net/StarDist/`.  
...
(If not in the list, click on `Add update site` and add it manually with URL `https://sites.imagej.net/StarDist/`.)
